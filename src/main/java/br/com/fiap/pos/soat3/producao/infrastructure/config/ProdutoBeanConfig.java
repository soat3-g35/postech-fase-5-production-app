...
import br.com.fiap.pos.soat3.producao.application.usecases.produto.AlteraProdutoInteractor;
import br.com.fiap.pos.soat3.producao.application.usecases.produto.BuscaPorCategoriaInteractor;
import br.com.fiap.pos.soat3.producao.application.usecases.produto.BuscaProdutoInteractor;
import br.com.fiap.pos.soat3.producao.application.usecases.produto.CadastraProdutoInteractor;
import br.com.fiap.pos.soat3.producao.application.usecases.produto.DeletaProdutoInteractor;
import br.com.fiap.pos.soat3.producao.infrastructure.controllers.produto.ProdutoDTOMapper;
import br.com.fiap.pos.soat3.producao.infrastructure.gateways.produto.ProdutoEntityMapper;
import br.com.fiap.pos.soat3.producao.infrastructure.gateways.produto.ProdutoRepositoryGateway;
import br.com.fiap.pos.soat3.producao.infrastructure.persistence.produto.ProdutoRepository;
